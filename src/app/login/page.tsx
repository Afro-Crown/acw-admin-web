      ...
      <div className="flex flex-col h-[70%] w-[80%] md:w-2/4 lg:min-w-[25%] lg:w-1/4 bg-white items-center">
        ...
        <div className="w-[80%]">
          ...
          <div className="flex flex-row justify-around mb-10">
            <button className="bg-[#c7c7c7] w-[45%] flex items-center justify-center py-4 gap-2 rounded-xl text-sm font-semibold">
              <FcGoogle size={20} /> Google
            </button>
            <button className="bg-[#3B5998] w-[45%] flex items-center justify-center py-4 gap-2 rounded-xl text-sm font-semibold">
              <BsFacebook size={20} fill="white" /> Facebook
            </button>
          </div>
        </div>
      </div>
