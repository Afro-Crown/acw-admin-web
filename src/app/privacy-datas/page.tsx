...
const PrivacyDatasScreen = () => {
  return ( 
    <main className="bg-white flex flex-col items-center justify-center">
      <Header />
      <div className="bg-white h-screen w-[60%] flex flex-row items-center justify-center">
        <article className="text-black flex flex-col justify-around h-full w-[70%]">
          <h1 className="w-[80%] text-2xl font-semibold">Políticas de privacidade e dados</h1>
          <p className="w-[80%] text-xs text-justify">
          ...
          <Link href={'/use-terms'}><span>Termos de uso </span></Link>
        </article>
        <div className="w-[30%] h-full flex flex-col items-start justify-start pt-24 text-gray-600 gap-2">
          <span className="text-xs">Navegue pelo índice:</span>
          <div className="w-[90%] bg-[#FFF5EA] h-[40%] text-black p-4 flex flex-col items-center gap-2">
...
export default PrivacyDatasScreen;