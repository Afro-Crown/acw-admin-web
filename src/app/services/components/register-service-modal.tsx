...
const RegisterServiceModal = ({ closeModal }: ModalAcceptProps) => {
  return ( 
    <div className="text-black fixed w-screen h-screen left-0 top-0 flex justify-center items-center bg-white bg-opacity-10">
